@extends('main/panel')
@section('content')
@if(count($phrases) > 0 && $phrase1 )
<div class="row mx-0" style="min-height: 100vh;">
  <div class="col-lg-12">
      <div class="container py-1 mt-5">
          <div class="d-flex justify-content-center" id="phrases">

            @foreach($phrases as $p)
            <a class="px-1 phrase" data-id="{{$p->id}}"><i class="fas fa-question-circle fa-2x"></i></a>
            @endforeach
          </div>
      </div>
      <div class="container py-1 mt-5">
        <div class="d-flex justify-content-center text-center">
          <audio class="audio-controls audio-controls-table" id="spanish-play" controls>
            <source src="{{url('/public/adminRecordings')}}/{{$phrase1->audio_spanish}}" type="video/webm"/>
          </audio>
        </div>
        <div class="justify-content-center mt-5 text-center">
          <div id="show-transcription" class="justify-content-center text-center">
            <button class="btn_submit" data-container="body" title="Spanish Transcription" data-toggle="popover" data-placement="top" data-content="{{$phrase1->text_spanish}}">See Transcription</button>
          </div>
            <input type="hidden" id="text-english" value="{{$phrase1->text_english}}"/>
          </div>
          <div class="row justify-content-center text-center mt-3">
              <div class="col-xl-4 justify-content-center text-center">
                <p>
                  ...
                  <a class="record" id="start-recording"><i class=" fas fa-microphone-alt fa-3x text-danger"></i></a>
                  <a class="record d-none" id="stop-recording"><i class=" fas fa-microphone-alt-slash fa-3x text-danger
"></i></a>
                  <div id="output"></div>
              ...
              <div class="col-md-6 col-align">
                <div id="green-transcript" >
                  <p class="pt-1">
                    ...
                    <span  class="text-success pl-1 ">{{$phrase1->text_english}}</span>
                  </p>
                </div>
              </div>
          ...
          <div id="partialcorrect" class="d-none">
            <div class="row">
              ...
              <div class="col-md-6 col-align">
                  <div class="row">
                    <div class="col-md-4 col-align">
                      <button class="btn_bar btn btn-warning answer-play-red float-right" id="makeWrongOrangePlay"><i class="fas fa-play "></i> Play</button>
                      <button class="btn_bar btn btn-warning answer-pause-red d-none float-right"><i class="fas fa-pause "></i> Pause</button>
                      <audio class="audio-controls d-none audio-controls-table" id="english-play" controls>
                        <source src="{{url('/public/adminRecordings')}}/{{$phrase1->audio_english}}" type="video/webm"/>
                      </audio>
                    </div>
                    <div class="col-md-8 col-align">
                      <div id="show-transcription-orange" class="justify-content-center text-center">
                        <button class="btn btn-warning btn_bar float-left" id="makeWrongOrangeTranscript" data-container="body" title="English Transcription" data-toggle="popover" data-placement="top" data-content="{{$phrase1->text_english}}">Let me see it</button>
              ...
              <div class="col-md-2 col-align">
                ...
                <button class="btn bnt_bar btn-warning float-right d-none finish" id="orange-finish">Finish</button>
              </div>
            </div>
          </div>
          ...
          <div id="incorrect" class="d-none">
            <div class="row">
              ...
              <div class="col-md-6 col-align">
                <div class="row">
                  <div class="col-md-4 col-align">
                    <button class="btn_bar btn- btn-danger answer-play-red float-right" id="makeWrongRedPlay"><i class="fas fa-play "></i> Play</button>
                    <button class="btn_bar btn btn-danger answer-pause-red d-none float-right"><i class="fas fa-pause "></i> Pause</button>
                    <audio class="audio-controls audio-controls-table d-none" id="english-play-red" controls>
                      <source src="{{url('/public/adminRecordings')}}/{{$phrase1->audio_english}}" type="video/webm"/>
                    </audio>
                  </div>
                  <div class="col-md-8 col-align">
                    <div id="show-transcription-red" class="justify-content-center text-center">
                      <button class="btn btn-danger btn_bar float-left" id="makeWrongRedTranscript" data-container="body" title="English Transcription" data-toggle="popover" data-placement="top" data-content="{{$phrase1->text_english}}">Let me see it</button>
...
<div class="row mt-5">
  <div class="col-md-12 justify-content-center text-center">
    <p class="justify-content-center text-center">
      No Phrases are Assigned to you yet!
    </p>
  </div>
</div>
@endif
 ...
 */
    ...
    $(document).on('click',".next",()=>{
      ...
      if(difference.length != 0){
        $.ajax({
          type:'get',
          url:'{{url("/user/panel/phrase/next")}}',
          data:{
            "_token": "{{ csrf_token() }}",
            "id": difference[0]
          },
          ...
          success:(res)=>{
            ...
            document.getElementById('spanish-play').innerHTML = '<source src={{url("/public/adminRecordings")}}/' + res.audio_spanish + ' type="video/webm"/>'
            document.getElementById('spanish-play').load()
            ...
            $("[data-toggle=popover]").popover()
            document.getElementById('green-transcript').innerHTML = '<p class="pt-1"><i class="fas fa-check text-success"></i><span  class="text-success pl-1">' + res.text_english + '</span></p>'
            //update to bar
            let k=''
        ...
        if(answers_main.length == mainList.length)
        {
          ...
          $.ajax({
            type:'post',
            url: '{{url("")}}/user/panel/phrase/answer-save',
            contentType: false,
                  cache: false,
                  processData: false,
            data:fd,
